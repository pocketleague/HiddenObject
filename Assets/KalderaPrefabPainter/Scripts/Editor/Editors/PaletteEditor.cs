...
namespace CollisionBear.WorldEditor
{
    ...
    public class PaletteEditor : Editor
    {
        ...
        private static readonly GUIContent ShortcutKeyContent = new GUIContent("Creates a shortcut key command of Shift + <key>");
        ...
        private static readonly GUIContent MultiplyPrefabScaleContent = new GUIContent("Multiply Prefab Scale", "If set, the scaling is multiplied by the scale of the prefab. Otherwise that prefab scale is ignored.");
