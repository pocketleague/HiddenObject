...
namespace CollisionBear.WorldEditor
{
    ...
    public class LayerObjectPlacementMode : IPlacementMode
    {
        ...
        public string HintText => "Every collider on the selected layer(s) is chosen. This is a great solution if you've built a level in Unity using a multitude of game object to act as the scene's floor.";
