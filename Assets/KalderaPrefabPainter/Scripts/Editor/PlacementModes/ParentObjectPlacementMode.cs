...
namespace CollisionBear.WorldEditor
{
    ...
    public class ParentObjectPlacementMode : IPlacementMode
    {
        ...
        public string HintText => "A single collider is chosen. This works great if you are painting against a Terrain object or any other, single geometry, object.";
        ...
        public string ValidatePlacementMode()
        {
            if (ParentCollider == null) {
                return "Please select a parent collider!\n\nThe parent collider is what all prefabs will be painted against. It can also be made the parent for all placed prefabs.\nThis object must be existing in the scene";
            }
